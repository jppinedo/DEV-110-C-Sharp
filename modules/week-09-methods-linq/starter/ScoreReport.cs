...
internal class ScoreReport
{
    ...
    private void PrintTopScores(int topCount)
    {
        ...
        string formatted = string.Join(", ", top);
        Console.WriteLine($"Top {topCount}: {formatted}");
    }
    ...
    private void PrintPassingScores()
    {
        ...
        string formatted = string.Join(", ", passingScores);
        Console.WriteLine($"Passing scores (desc): {formatted}");
    }
    ...
    private void PrintFailingScores()
    {
        ...
        string formatted = string.Join(", ", failingScores);
        Console.WriteLine($"Failing scores (desc): {formatted}");
    }
}
